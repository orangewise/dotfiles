...
symlink_files="aliases bower functions git-prompt gitprompt git-imgdiff oracle oracle_11_2 oronjo ck ow xc droid www textmate macports heroku_toolbelt homebrew ruby rbenv apportable_toolkit jshintrc awsenv meteorenv"  
