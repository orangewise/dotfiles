...
symlink_files="aliases bower functions git-prompt gitprompt oracle oracle_11_2 ow ck ow xc droid www textmate macports heroku_toolbelt homebrew ruby rbenv apportable_toolkit jshintrc docker"  
