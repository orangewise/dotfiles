...
symlink_files="aliases bower functions git-prompt gitprompt oracle ow ck ow xc droid www textmate macports heroku_toolbelt homebrew ruby rbenv apportable_toolkit"  
